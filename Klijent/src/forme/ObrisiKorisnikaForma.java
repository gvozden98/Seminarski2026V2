 ...
 * @author Ognjen
 */
public class ObrisiKorisnikaForma extends javax.swing.JFrame {

    /**
     * Creates new form ObrisiKorisnikaForma
     */
    public ObrisiKorisnikaForma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Obrisi korisnika");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObrisiKorisnikaForma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ObrisiKorisnikaForma().setVisible(true);
            }
        });
    }
